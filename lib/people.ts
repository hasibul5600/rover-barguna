...
const CONTACT_FIELDS: PeopleField[] = [
  ...
  { key: "email", label: "ইমেইল", type: "email", placeholder: "name@example.com" },
];
...
export const MEMBER_PEOPLE: PeopleConfig = {
  ...
  emptyIcon: "👥",
  namePlaceholder: "যেমন: মোঃ রিফাত হোসেন",
  ...
  fields: [
    ...
    { key: "session", label: "সেশন", type: "text", placeholder: "২০২৩-২৪" },
    { key: "roll", label: "রোল নম্বর", type: "text", placeholder: "১২৩৪৫৬" },
    BLOOD_FIELD,
    ...CONTACT_FIELDS,
  ],
  bioLabel: "সংক্ষিপ্ত পরিচিতি",
  bioPlaceholder: "সদস্যের অর্জন, দায়িত্ব বা আগ্রহ সম্পর্কে দুই লাইন…",
...
export const EX_MEMBER_PEOPLE: PeopleConfig = {
  ...
  emptyIcon: "🎓",
  namePlaceholder: "যেমন: মোঃ সাকিব আহমেদ",
  subtitleKeys: ["session", "passingYear"],
  fields: [
    ...
    { key: "department", label: "বিভাগ", type: "select", options: DEPARTMENTS, placeholder: "বিভাগ নির্বাচন করুন", inTable: true },
    { key: "session", label: "সেশন", type: "text", placeholder: "২০১৮-১৯" },
    { key: "passingYear", label: "বিদায়ের বছর", type: "text", placeholder: "২০২২" },
    BLOOD_FIELD,
    { key: "occupation", label: "বর্তমান পেশা / কর্মস্থল", type: "text", placeholder: "যেমন: ইলেকট্রিক্যাল টেকনিশিয়ান, বরগুনা", inTable: true, tableLabel: "বর্তমান অবস্থান" },
    ...CONTACT_FIELDS,
  ],
  bioLabel: "স্মৃতি ও অবদান",
  bioPlaceholder: "গ্রুপে থাকাকালীন দায়িত্ব, অর্জন বা স্মরণীয় কাজ সম্পর্কে দুই লাইন…",
...
export const REQUEST_PEOPLE: PeopleConfig = {
  ...
  bioPlaceholder: "আবেদনকারীর লেখা কারণ…",
  photo: false,
